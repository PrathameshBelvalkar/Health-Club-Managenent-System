<%-- 
    ...
    Created on : Mar 19, 2021, 10:01:17 AM
    Author     : DELL
--%>
...
<!--        <div class="col-md-4"></div>-->
	...
	<tr>
		<td style="color: black;font-family:Rockwell;">Package Name-<label><b><%out.print(rs.getString(1));%></b></label></td>
	</tr>
	<tr>
            <td style="color: black;font-family:Rockwell">Cost:-<label><b><%out.print(rs.getString(2));%></b></label></td>
	</tr>
	<tr>
		<td style="color: black;font-family:Rockwell">Duration:-<label><b><%out.print(rs.getString(3));%></b></label></td>
	</tr>
        <tr>
            <td style="color: black;font-family: Rockwell"><input type="submit" value="BOOK NOW"  style="cursor: pointer"></td>
