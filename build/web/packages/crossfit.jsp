<%-- 
    Document   : crossfit
    Created on : Apr 8, 2021, 5:42:24 PM
    Author     : DELL
--%>
        ...
        <div class="form-box">
            <table border="1">
                ...
                <tr>
                    ...
                    <td class="dis">
                        <strong>Crossfit</strong> is a strength and conditioning workout that is made up
                        of functional movement performed at high intensity level.This movement are action 
                        that you perform in ypur day to day life,like squatting,pulling,pushing etc.
                        <h6><a href="" class="wiki">wikipedia</a></h6>
                    </td>
                    <td>
                        <img src="../upload/Pec-deck-machine.jpg" alt=""/>
                        <img src="../upload/Leg-press-machine.jpg" alt=""/>
                        <br>
                        <img src="../upload/Hack-squat-machine.jpg" alt=""/>
                        <img src="../upload/Lat-pulldown-machine.jpg" alt=""/>
                    </td>
                </tr>
            </table>
            </div>  
