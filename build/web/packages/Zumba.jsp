<%-- 
    Document   : Zumba
    Created on : Apr 8, 2021, 6:29:10 PM
    Author     : DELL
--%>
        ...
        <div class="form-box">
            <table border="1">
                ...
                <tr>
                    ...
                    <td class="dis">
                        <strong>Zumba</strong> is fitness program that combines latin and international music with
                        dance moves.Zumba routines incorporate interval training alternating fast and slow rhythms
                        to help improve cardiovascular fitness.
                        <h6><a href="" class="wiki">wikipedia</a></h6>
                    </td>
                    <td>
                        <img src="../upload/Zumba.png" alt=""/>
                    </td>
                </tr>
            </table>
            </div>  
