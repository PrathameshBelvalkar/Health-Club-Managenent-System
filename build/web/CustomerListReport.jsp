<%-- 
    Document   : CustomerListReport
    Created on : Feb 22, 2021, 4:57:39 PM
    Author     : DELL
--%>
...
<!--        <div class="col-md-4"></div>-->
      <div class="col-lg-12 footer2 wow bounceInUp" data-wow-delay=".25s" id="contact">
        <div class="form-box">
          <h4>Customer list</h4>
      ...
      <%
        ...
        out.print("<table class='table table-responsive d-table' style='color: black;width:50%;'>");
        out.print("<tr>");
        ...
        out.print("<th>Disease profile</th>");
