<%-- 
    Document   : cardio
    Created on : Apr 8, 2021, 3:30:54 PM
    Author     : DELL
--%>
        ...
        <div class="form-box">
            <table border="1">
                ...
                <tr>
                    ...
                    <td class="dis">
                        <strong>Cardiovascular</strong> exercise is exercise that gets your heart rate up.
                        Though some people use it solely for weight loss,cardio has another benefit as well.
                        <h6><a href="" class="wiki">wikipedia</a></h6>
                    </td>
                    <td>
                        <img src="../upload/Upright-bike.jpg" alt=""/>
                        <br>
                        <img src="../upload/treadmill.jpg" alt=""/>
