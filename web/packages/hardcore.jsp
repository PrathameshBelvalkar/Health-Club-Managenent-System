<%-- 
    Document   : hardcore
    Created on : Apr 8, 2021, 3:37:45 PM
    Author     : DELL
--%>
...
<!--  <title>Fox - Free One Page Template, Free Fitness HTML5 Template by FreeHTML5.co</title>-->
  ...
  <nav class="navbar navbar-expand-md navbar-dark">
    <div class="container"> 
      <!-- Brand --> 
      <a class="navbar-brand mr-auto" href="#"><h1>Packages</h1></a> 
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
       <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"> <a class="nav-link" href="../searchpackage.jsp">All packages</a> </li>
        ...
        <div class="form-box">
            <table border="1">
                ...
                <tr>
                    ...
                    <td class="dis">
                        <strong>Hardcore</strong> training involves the performance of physical exercise which 
                        are designed to improve strength and endurance. It is often associated with the use of 
                        weight. 
                        <h6><a href="" class="wiki">wikipedia</a></h6>
                    </td>
                    <td>
                        <img src="../upload/Adjustable-dumbbell.jpg" alt=""/>
                        <img src="../upload/Dip-bar.jpg" alt=""/>
                        <br>
                        <img src="../upload/Hack-squat-machine.jpg" alt=""/>
                        <img src="../upload/Standard-weight-plate.jpg" alt=""/>
                        <br>
                        <img src="../upload/Recumbent-exercise-bike.jpg" alt=""/>
                        <img src="../upload/Weight-tree.jpg" alt=""/>
                    </td>
                </tr>
            </table>
            </div>  
