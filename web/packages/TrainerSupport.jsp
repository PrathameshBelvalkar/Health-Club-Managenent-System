<%-- 
    Document   : TrainerSupport
    Created on : Apr 8, 2021, 6:05:53 PM
    Author     : DELL
--%>
...
<!--        <div class="col-md-4"></div>-->
      <div class="col-md-12 footer2 wow bounceInUp" data-wow-delay=".25s" id="contact">
        <div class="form-box">
            <h1 class="text"> &#128515 Trainers will be assign as per your Requirements</h1>
            &nbsp;&nbsp;&nbsp;
            <a href="Allpackage.jsp" class="go">Go Back To Our Packages</a>
